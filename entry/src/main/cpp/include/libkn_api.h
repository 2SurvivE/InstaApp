...
typedef struct {
  libkn_KNativePtr pinned;
} libkn_kref_com_example_shared_core_bridge_LogService;
typedef struct {
  libkn_KNativePtr pinned;
} libkn_kref_com_example_shared_core_bridge_LogServiceProxy;
typedef struct {
  libkn_KNativePtr pinned;
} libkn_kref_kotlin_Any;
typedef struct {
  libkn_KNativePtr pinned;
} libkn_kref_com_example_shared_service_CalcServiceProvider;
typedef struct {
  libkn_KNativePtr pinned;
...
typedef struct {
  libkn_KNativePtr pinned;
} libkn_kref_com_example_shared_service_CalcService;
            ...
            struct {
              struct {
                struct {
                  ...
                  libkn_kref_com_example_shared_core_bridge_LogServiceProxy (*LogServiceProxy)();
                  void (*debug)(libkn_kref_com_example_shared_core_bridge_LogServiceProxy thiz, const char* tag, const char* msg);
                  void (*error)(libkn_kref_com_example_shared_core_bridge_LogServiceProxy thiz, const char* tag, const char* msg);
                  void (*fatal)(libkn_kref_com_example_shared_core_bridge_LogServiceProxy thiz, const char* tag, const char* msg);
                  void (*info)(libkn_kref_com_example_shared_core_bridge_LogServiceProxy thiz, const char* tag, const char* msg);
                  void (*warn)(libkn_kref_com_example_shared_core_bridge_LogServiceProxy thiz, const char* tag, const char* msg);
                } LogServiceProxy;
                struct {
                  libkn_KType* (*_type)(void);
                  void (*debug)(libkn_kref_com_example_shared_core_bridge_LogService thiz, const char* tag, const char* msg);
                  void (*error)(libkn_kref_com_example_shared_core_bridge_LogService thiz, const char* tag, const char* msg);
                  void (*fatal)(libkn_kref_com_example_shared_core_bridge_LogService thiz, const char* tag, const char* msg);
                  void (*info)(libkn_kref_com_example_shared_core_bridge_LogService thiz, const char* tag, const char* msg);
                  void (*warn)(libkn_kref_com_example_shared_core_bridge_LogService thiz, const char* tag, const char* msg);
                } LogService;
                libkn_kref_com_example_shared_core_bridge_LogService (*getLogServiceApi)();
              } bridge;
              struct {
                void (*DEBUG)(libkn_kref_kotlin_Any thiz, const char* msg);
                void (*ERROR)(libkn_kref_kotlin_Any thiz, const char* msg);
                void (*FATAL)(libkn_kref_kotlin_Any thiz, const char* msg);
                void (*INFO)(libkn_kref_kotlin_Any thiz, const char* msg);
                void (*WARN)(libkn_kref_kotlin_Any thiz, const char* msg);
              } logger;
            } core;
            struct {
              struct {
                libkn_KType* (*_type)(void);
                libkn_kref_com_example_shared_service_CalcServiceProvider (*CalcServiceProvider)();
                libkn_KInt (*getMinParamsSize)(libkn_kref_com_example_shared_service_CalcServiceProvider thiz, const char* method);
                libkn_kref_kotlin_Array (*getParamsTypeList)(libkn_kref_com_example_shared_service_CalcServiceProvider thiz, const char* method);
                libkn_kref_kotlin_reflect_KClass (*getReturnType)(libkn_kref_com_example_shared_service_CalcServiceProvider thiz, const char* method);
                libkn_kref_kotlin_Any (*invoke)(libkn_kref_com_example_shared_service_CalcServiceProvider thiz, const char* method, libkn_kref_kotlin_Array params);
              } CalcServiceProvider;
              struct {
                libkn_KType* (*_type)(void);
                libkn_kref_com_example_shared_service_CalcService (*CalcService)();
                libkn_KInt (*add)(libkn_kref_com_example_shared_service_CalcService thiz, libkn_KInt a, libkn_KInt b);
              } CalcService;
            } service;
          } shared;
        } example;
        struct {
          struct {
            struct {
              struct {
                struct {
                  void (*registerLogServiceProxy)();
                  void (*registerCalcServiceProvider)();
                } shared;
                void (*initShared)();
              } modules;
              void (*initBridge)();
